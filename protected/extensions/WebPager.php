...
class webPager extends CLinkPager{
	...
	const CSS_FIRST_PAGE='previous disabled first';
	...
	public function run()
	{
		...
		echo '&nbsp;&nbsp;<label style="float:left;margin-top: 27px;"> '.$startRecord.' - '.$endRecord. ' of '.$totalRecord.'&nbsp;&nbsp; <img id="paginationLoader" src="themefiles/assets/admin/layout/img/input-spinner.gif" style="margin-bottom:9px;display:none;"></label>&nbsp;&nbsp;';
		echo $this->footer;
	}
	...
	protected function createPageButton($label,$page,$class,$hidden,$selected)
	{
		...
		return '<li class="'.$class.' paginate_button ">'.CHtml::link($label,$this->createPageUrl($page).'&'.$this->extraPara).'</li>';
	}
