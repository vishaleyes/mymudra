...
//echo $_SESSION['prefferd_language'];
if(!isset($_SESSION['prefferd_language']))
{
	$_SESSION['prefferd_language']=DEFAULT_LANGUAGE;
}
//echo $_SESSION['prefferd_language'];exit;
$this->smarty = new smartyML($_SESSION['prefferd_language']);
