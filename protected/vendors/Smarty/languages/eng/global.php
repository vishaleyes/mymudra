...
$messages['_EMAIL_ALREADY_REGISTER_'] = "Email address already registered please try with other emailId.";

$messages['_SUCCESS_'] = "Success";
$messages['_DATA_NOT_FOUND_'] = "Data not found.";
$messages['_GETTING_ERROR_REGISTRATION_'] = "Getting issue while doing customer registration.";
