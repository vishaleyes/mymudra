    ...
    <td style="vertical-align: top;"><center style="width: 100%;">
        ...
        <div style="max-width: 600px;"> 
          ...
          <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="100%" style="max-width: 600px;">
            ...
            <tr>
              <td class="full-width-image" align="left" ><img src="<?php echo Yii::app()->params->base_url ; ?>assets/images_email/block_customer.png" width="600" alt="alt_text" border="0" style="width: 100%; max-width: 600px; height: auto;"> </td>
            </tr>
                             ...
                             <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                 <tr>
                                     <td style="padding:10px 40px; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
                                         <h3 style="text-align: center;">##_EMAIL_CUSTOMER_DELETE_HEADER_##</h3>

                                         <b> Dear ##_TMP_USER_HELLO_##, </b><br>
                                         <p>##_EMAIL_DELETE_CUSTOMER_ACCOUNT_TEXT_##, </p>
                                         ##_EMAIL_DELETE_CUSTOMER_RELOGIN_CONTACT_ADMIN_##
                                         <br>
                                         <!-- Button : Begin -->
                                         <br>
