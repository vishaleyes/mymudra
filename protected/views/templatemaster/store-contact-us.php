        ...
        <td style="vertical-align: top;"><center style="width: 100%;">
                ...
                <div style="max-width: 600px;">
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="100%" style="max-width: 600px;">
                        ...
                        <tr>
                            <td class="full-width-image" align="left" ><img src="<?php echo Yii::app()->params->base_url ; ?>assets/images_email/store.png" width="600" alt="alt_text" border="0" style="width: 100%; max-width: 600px; height: auto;"> </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                    ...
                                    <tr>
                                        <td align="center" style="padding:10px 40px; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 12px; color: #555555;text-align: center;"><h3>##_EMAIL_TMP_SUPPORT_TEXT_##</h3><b> _COMMENT_ </b><br /></td>
                                    </tr>
                                    <tr>
