<?php /* Smarty version Smarty-3.1.7, created on 2012-01-31 10:36:55
         compiled from "D:\xampp\htdocs\todooliapp\themes\seethrulandscape\views\layouts\main.tpl" */ ?>
<?php /*%%SmartyHeaderCode:76034f27763345c763-86021812%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bba1c904e94b1096710f70c7c1c3f71e42c7dd2c' => 
    array (
      0 => 'D:\\xampp\\htdocs\\todooliapp\\themes\\seethrulandscape\\views\\layouts\\main.tpl',
      1 => 1327986413,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '76034f27763345c763-86021812',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_4f2776335cb88',
  'variables' => 
  array (
    'Yii' => 0,
    'base_path' => 0,
...
<?php if ($_valid && !is_callable('content_4f2776335cb88')) {function content_4f2776335cb88($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
var BASHPATH='<?php echo $_smarty_tpl->tpl_vars['base_path']->value;?>
';
...
/js/jquery-ui-1.8.13.custom.min.js"></script>
    <!-- Header Part -->
  <?php if ($_smarty_tpl->tpl_vars['generalError']->value=='1'){?>
...
/images/logo/##_SITENAME_NO_CAPS_##-254.png" alt="##_LOGO_ALTER_##" border="0" /></a>
                            ...
                            <div class="login">
                                <form name="loginorm" id="loginform" action="<?php echo $_smarty_tpl->tpl_vars['base_path']->value;?>
...
" <?php }?> />
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="color:#ffffff;">
                                                <div align="left" style="margin-top:-3px;"><b><a href="<?php echo $_smarty_tpl->tpl_vars['base_path']->value;?>
...
<ul id="languagelist">
 <li class="selected en"><a lang="en" href="<?php echo $_smarty_tpl->tpl_vars['base_path']->value;?>
user/prefferedLanguage/eng"><?php if ($_SESSION['prefferd_language']=='eng'){?><strong>English</strong><?php }else{ ?><span>English</span><?php }?></a></li>
 <li class="es"><a lang="es" href="<?php echo $_smarty_tpl->tpl_vars['base_path']->value;?>
user/prefferedLanguage/spn"><?php if ($_SESSION['prefferd_language']=='spn'){?><strong>Espanol</strong><?php }else{ ?><span>Espanol</span><?php }?></a></li>
  <li class="es"><a lang="es" href="<?php echo $_smarty_tpl->tpl_vars['base_path']->value;?>
user/prefferedLanguage/fr"><?php if ($_SESSION['prefferd_language']=='fr'){?><strong>French</strong><?php }else{ ?><span>French</span><?php }?></a></li>
   <li class="es"><a lang="es" href="<?php echo $_smarty_tpl->tpl_vars['base_path']->value;?>
user/prefferedLanguage/prtg"><?php if ($_SESSION['prefferd_language']=='prtg'){?><strong>Portuguese</strong><?php }else{ ?><span>Portuguese</span><?php }?></a></li>
 </ul>
